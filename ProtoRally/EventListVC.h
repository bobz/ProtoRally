...
#import "EventModel.h"
@interface EventListVC : UITableViewController <NSFetchedResultsControllerDelegate, UISearchDisplayDelegate, EventModelUpdatedListener, ActiveEventChangedListener>
{
